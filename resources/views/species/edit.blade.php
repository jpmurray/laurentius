...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <form method="POST" action="{{ route('species.update', $species) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select id="hardiness_ca" class="custom-select @error('hardiness_ca') is-invalid @enderror" name="hardiness_ca">
                                        <option value="null">{{ __('Unknown') }}</option>
                                        @foreach(App\Species::HARDINESS_CA as $key => $hardiness)
                                        <option value="{{ $hardiness }}" @if($species->hardiness_ca == $hardiness) SELECTED @endif>{{ __($hardiness) }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6">
                                    @foreach(App\Species::SUN as $key => $sun)
                                        <div class="custom-control custom-switch">
                                            ...
                                            <label class="custom-control-label" for="sun_{{ $sun }}">{{ ucfirst(__($sun)) }}</label>
                                        </div>
                                    @endforeach
                                ...
                                <div class="col-md-6">
                                    @foreach(App\Species::SOIL as $key => $soil)
                                        <div class="custom-control custom-switch">
                                            ...
                                            <label class="custom-control-label" for="soil_{{ $soil }}">{{ ucfirst(__($soil)) }}</label>
                                        </div>
                                    @endforeach
                                ...
                                <div class="col-md-8">
                                    @foreach(App\Species::WATER as $key => $water)
                                        <div class="form-check form-check-inline">
                                            ...
                                            <label class="form-check-label" for="water_{{ $water }}">{{ ucfirst(__($water)) }}</label>
                                        </div>
                                    @endforeach
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="custom-control custom-switch">
                                      ...
                                      <label class="custom-control-label" for="shape_{{ $shape }}">{{ ucfirst(__($shape)) }}</label>
                                    </div>
                                    @endforeach
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="custom-control custom-switch">
                                      ...
                                      <label class="custom-control-label" for="root_{{ $root }}">{{ ucfirst(__($root)) }}</label>
                                    </div>
                                    @endforeach
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="custom-control custom-switch">
                                      ...
                                      <label class="custom-control-label" for="wildlife_use_{{ $use }}">{{ ucfirst(__($use)) }}</label>
                                    </div>
                                    @endforeach
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="custom-control custom-switch">
                                      ...
                                      <label class="custom-control-label" for="ecological_use_{{ $use }}">{{ ucfirst(__($use)) }}</label>
                                    </div>
                                    @endforeach
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="custom-control custom-switch">
                                      ...
                                      <label class="custom-control-label" for="pollinating_type_{{ $type }}">{{ ucfirst(__($type)) }}</label>
                                    </div>
                                    @endforeach
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="custom-control custom-switch">
                                      ...
                                      <label class="custom-control-label" for="comestible_use_{{ $use }}">{{ ucfirst(__($use)) }}</label>
                                    </div>
                                    @endforeach
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="custom-control custom-switch">
                                      ...
                                      <label class="custom-control-label" for="flowering_period_{{ $period }}">{{ ucfirst(__($period)) }}</label>
                                    </div>
                                    @endforeach
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="custom-control custom-switch">
                                      ...
                                      <label class="custom-control-label" for="flowering_color_{{ $color }}">{{ ucfirst(__($color)) }}</label>
                                    </div>
                                    @endforeach
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="custom-control custom-switch">
                                      ...
                                      <label class="custom-control-label" for="foliage_color_{{ $color }}">{{ ucfirst(__($color)) }}</label>
                                    </div>
                                    @endforeach
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="custom-control custom-switch">
                                      ...
                                      <label class="custom-control-label" for="post_summer_appeal_{{ $season }}">{{ ucfirst(__($season)) }}</label>
                                    </div>
                                    @endforeach
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="custom-control custom-switch">
                                      ...
                                      <label class="custom-control-label" for="growth_{{ $speed }}">{{ ucfirst(__($speed)) }}</label>
                                    </div>
                                    @endforeach
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="custom-control custom-switch">
                                      ...
                                      <label class="custom-control-label" for="pruning_period_{{ $period }}">{{ ucfirst(__($period)) }}</label>
                                    </div>
                                    @endforeach
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="custom-control custom-switch">
                                      ...
                                      <label class="custom-control-label" for="multiplication_{{ $method }}">{{ ucfirst(__($method)) }}</label>
                                    </div>
                                    @endforeach
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="custom-control custom-switch">
                                      ...
                                      <label class="custom-control-label" for="disadvantages_{{ $reason }}">{{ ucfirst(__($reason)) }}</label>
                                    </div>
                                    @endforeach
