...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">{{ __('Edit :name', ['name' => $supplier->name]) }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('suppliers.update', $supplier) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="url" type="text" class="form-control @error('url') is-invalid @enderror" name="url" value="{{ $supplier->url }}" required autocomplete="url" autofocus>
